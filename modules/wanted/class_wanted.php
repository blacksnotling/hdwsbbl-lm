                ...
                <table class="common">
                    <tr>
                        <td colspan="2" align="left" valign="top">
                            <strong><?php echo $lng->getTrn('g_title', __CLASS__);?>:</strong><br>
                            <?php echo $e->bounty;?>
                            <br>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <br>
                        <strong><?php echo $lng->getTrn('g_about', __CLASS__);?>:</strong><br>
                        <?php 
                        echo $e->why;
                        if ($e->date_died) {
                            echo "<br><br><font color='red'><strong>".$lng->getTrn('killed', __CLASS__)."</strong></font>\n";
                        }
                        ?>
                        </td>
