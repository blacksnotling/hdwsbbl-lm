...
private static function make_menu()
{
    global $lng, $coach, $settings, $rules, $admin_menu;
    ?>
    <ul class="css3menu1 topmenu" id="navigation">
...
<li class="topmenu"><a rel="nofollow" href="#">Rosters</a>
  <ul>
...
#    echo "<div id='$ID' class='assistantBox' style='$style'>".$body.'</div>';
  ...
  //Displays at the bottom of all pages before the closing HTML tags
